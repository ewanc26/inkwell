...
- **Android :** votre session OAuth est conservée dans EncryptedSharedPreferences, adossée à une MasterKey matérielle, et elle est explicitement exclue de la sauvegarde Android et du transfert d'appareil, car sa clé de Keystore ne peut pas être restaurée de façon sûre. L'état des notifications, les URI d'enregistrements déjà vus et les préférences sont conservés dans des SharedPreferences ordinaires, privées à l'application.
