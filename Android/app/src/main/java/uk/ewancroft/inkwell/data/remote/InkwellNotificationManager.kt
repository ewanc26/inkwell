...
class InkwellNotificationManager @Inject constructor(
    ...
    private fun sendNotification(title: String, body: String, documentURI: String) {
        val intent = Intent(context, MainActivity::class.java).apply {
            ...
            // Include the document in the PendingIntent identity as well as the
            // extra, so Android cannot collapse two document notifications.
            data = Uri.Builder()
                .scheme("inkwell")
                .authority("document")
                .appendQueryParameter("uri", documentURI)
                .build()
        }

        val pendingIntent = PendingIntent.getActivity(
            context, documentURI.hashCode(), intent,
