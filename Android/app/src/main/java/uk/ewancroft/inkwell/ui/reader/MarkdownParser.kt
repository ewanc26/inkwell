 ...
 * common to all standard.site providers. Mirrors the iOS MarkdownParser
 * in ContentProvider.swift. Not a full CommonMark parser, but sufficient
 * for the reader's rendering needs.
 */
object MarkdownParser {
    ...
    private fun parseList(lines: List<String>, start: Int, ordered: Boolean): Pair<List<MarkdownListItem>, Int> {
