...
//  legal/privacy.md and legal/terms.md — do not hand-edit it. Edit the
//  source and run `node tools/legal/render.mjs`.
//
    ...
    var content: LocalizedStringKey {
        ...
        case .privacyPolicy:
            ...
            **1. Who is responsible for your data**
            ...
            Contact: contact@ewancroft.uk. There is no separately appointed Data Protection Officer; Inkwell is not required to appoint one.
            ...
            **7. In-app feedback (optional)**
            ...
            If you use the “Send Feedback” feature, Inkwell creates an `app.userinput.discussion` record **in your own repository**, pointing at Inkwell’s feedback space on userinput.app, which is operated by the developer. That record is public: it contains the title and body you wrote, the time you wrote it, and is attributable to your DID and handle. It is visible to anyone on the AT Protocol network and may be mirrored by third-party indexes and relays outside the developer’s control.
            ...
            **15. Contact**
            ...
            For privacy-related enquiries, email contact@ewancroft.uk or open an issue on the Inkwell GitHub repository.
            """
