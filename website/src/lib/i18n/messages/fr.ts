...
export const fr: Messages = {
  ...
  meta: {
    ...
    "/security": {
      ...
      description:
        "Comment Inkwell gère l'authentification, le stockage des clés et la vérification : OAuth 2.1 avec jetons liés par DPoP, aucun mot de passe d'application, stockage local dans le Keychain ou EncryptedSharedPreferences, et aucun suivi ni statistique.",
    },
    "/about": {
    ...
    compare: {
      ...
      rows: [
        ...
        },
        {
          ...
          app: "Conservés dans le Keychain ou EncryptedSharedPreferences",
        },
        {
  ...
  security: {
    ...
    cards: {
      ...
      storage: {
        ...
        body: "Votre session OAuth et votre clé privée DPoP sont conservées dans le stockage sécurisé de la plateforme, et non dans des préférences lisibles par l'application : le Keychain d'Apple sur iOS, et EncryptedSharedPreferences adossé à une MasterKey matérielle sur Android. Android exclut la session OAuth de la sauvegarde et du transfert d'appareil, car la clé du Keystore ne peut pas être restaurée de façon sûre. La déconnexion ou la désinstallation les supprime. Le détail complet — y compris le comportement de sauvegarde sur chaque plateforme — figure dans la [politique de confidentialité](privacy).",
      },
      analytics: {
